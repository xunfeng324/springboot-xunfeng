...
//        testStream1();
    ...
    private static void testStream1() {
        ...
        System.out.println("获取空字符串的数量:" + count2);
        ...
        String mergedString3 = strings3.stream().filter(string -> !string.isEmpty()).collect(Collectors.joining(", "));
        System.out.println("合并字符串: " + mergedString3);
